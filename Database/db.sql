...
CREATE TABLE `admin_can_edit_inv` (
  ...
  CONSTRAINT `AdminEdits` FOREIGN KEY (`AdminID`) REFERENCES `admin` (`UserID`),
...
CREATE TABLE `admin_set_attribute` (
  ...
  CONSTRAINT `AdminSet` FOREIGN KEY (`AdminID`) REFERENCES `admin` (`UserID`)
...
CREATE TABLE `magic_weapon` (
  ...
  CONSTRAINT `MagicID` FOREIGN KEY (`WeaponID`) REFERENCES `weapon` (`ItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `melee_weapon` (
  ...
  PRIMARY KEY (`WeaponID`),
  CONSTRAINT `MeleeID` FOREIGN KEY (`WeaponID`) REFERENCES `weapon` (`ItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ranged_weapon` (
  ...
  PRIMARY KEY (`WeaponID`),
  CONSTRAINT `RangedID` FOREIGN KEY (`WeaponID`) REFERENCES `weapon` (`ItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `set_vendor_offers` (
  ...
  CONSTRAINT `AdminVendSer` FOREIGN KEY (`AdminID`) REFERENCES `admin` (`UserID`),
...
-- Dump completed on 2023-04-05 21:13:48
